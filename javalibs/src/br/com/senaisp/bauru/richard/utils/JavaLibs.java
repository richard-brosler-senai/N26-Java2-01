package br.com.senaisp.bauru.richard.utils;
...
public class JavaLibs {
	...
	public static void main(String[] args) {
		...
		if (resp == JOptionPane.YES_OPTION) {
			...
			//Resultados
			titulo = "Obrigado!";
			mensagem= "Obrigado, "+q01.toLowerCase()+". Aproveite seu encontro e conversaremos com você mais tarde no programa!";
			JOptionPane.showMessageDialog(null,mensagem,titulo,JOptionPane.INFORMATION_MESSAGE,null);

			titulo = "Bem-vindo de volta!";
			mensagem= "Bem-vindo de volta, "+q01.toLowerCase()+"! Diga-me, como você acha que foi seu encontro? É verdade que as pessoas geralmente ficam felizes depois de namorar você?";
			int resp02 = JOptionPane.showConfirmDialog(null,mensagem,titulo,JOptionPane.YES_NO_OPTION,JOptionPane.INFORMATION_MESSAGE);
			
			titulo = "Surpresa!";
			mensagem= "Seu par, Alex, está ouvindo nos bastidores e pode discordar de você. Senhoras e senhores, por favor, deem as boas-vindas a Alex!";
			...
			mensagem= "Tenho muito a te contar sobre meu encontro com "+q01.toUpperCase()+"! Primeiro, jantamos.\n"
					+ "Convenci "+q01.toUpperCase()+" de que deveríamos dividir o(a) "+q06.toUpperCase()+" do "+q04.toUpperCase()+
					...
					+ "uma gorjeta de "+qi10+"!\n"+q01.toUpperCase()+" disse que era apenas "+(qi10/qi09*100)+"% de uma refeição de "+qi09+".\n\n"+
					"Nós terminamos a noite com um filme chamado \"Ataque do(a) "+ q03.toUpperCase()+"\".\nEu " + 
					q08.toUpperCase() + " com " + q01.toUpperCase() + ", e foi aí que eu realmente comecei a apreciar o quão " + q05.toUpperCase() + 
					" " + q01.toUpperCase() + " era.\nEstou apaixonado(a) e quero que " + q01.toUpperCase() + " se case comigo!";
			JOptionPane.showMessageDialog(null,mensagem,titulo,JOptionPane.WARNING_MESSAGE,null);
